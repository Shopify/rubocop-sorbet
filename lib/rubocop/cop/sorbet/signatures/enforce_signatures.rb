    ...
    module Sorbet
      ...
      class EnforceSignatures < ::RuboCop::Cop::Base
        ...
        def check_node(node)
          ...
          has_sig = sig_checker.has_signature?(node, scope)
          has_rbs = rbs_checker.has_signature?(node)
